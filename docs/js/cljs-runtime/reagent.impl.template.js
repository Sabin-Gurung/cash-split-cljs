...
var G__22157 = o;
reagent.impl.template.goog$module$goog$object.set(G__22157,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__22175__delegate = function (args){
...
while (G__22176__i < G__22176__a.length) {G__22176__a[G__22176__i] = arguments[G__22176__i + 0]; ++G__22176__i;}
  args = new cljs.core.IndexedSeq(G__22176__a,0,null);
} 
return G__22175__delegate.call(this,args);};
G__22175.cljs$lang$maxFixedArity = 0;
G__22175.cljs$lang$applyTo = (function (arglist__22177){
var args = cljs.core.seq(arglist__22177);
return G__22175__delegate(args);
});
...
while (G__22179__i < G__22179__a.length) {G__22179__a[G__22179__i] = arguments[G__22179__i + 0]; ++G__22179__i;}
  args = new cljs.core.IndexedSeq(G__22179__a,0,null);
} 
...
var G__22159 = props;
var G__22159__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22159,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22159);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22159__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22160 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22160,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22160;
}
})(),id_class);
...
var G__22161 = (cljs.core.count(argv) - first_child);
switch (G__22161) {
case (0):
...
var vec__22162 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22162,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22162,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22162,(2),null);
...
var temp__5808__auto___22182 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___22182 == null)){
} else {
var key_22183 = temp__5808__auto___22182;
(jsprops.key = key_22183);
}
...
var temp__5808__auto___22184 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___22184 == null)){
} else {
var key_22185 = temp__5808__auto___22184;
...
var temp__5808__auto___22186 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___22186 == null)){
} else {
var key_22187 = temp__5808__auto___22186;
(jsprops.key = key_22187);
}
...
var temp__5808__auto___22188 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
...
var temp__5808__auto___22190 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___22190 == null)){
} else {
var key_22191 = temp__5808__auto___22190;
(jsprops.key = key_22191);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22165_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22165_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22166 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22166,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22166,(1),null);
...
break;
default:
var G__22193 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22194 = compiler;
v = G__22193;
compiler = G__22194;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template22172 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template22172 = (function (opts,id,fn_to_element,parse_fn,meta22173){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22172.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22174,meta22173__$1){
var self__ = this;
var _22174__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22172(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22173__$1));
}));

(reagent.impl.template.t_reagent$impl$template22172.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22174){
var self__ = this;
var _22174__$1 = this;
return self__.meta22173;
}));

(reagent.impl.template.t_reagent$impl$template22172.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22172.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22172.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22172.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22172.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22172.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22173","meta22173",279228458,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22172.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22172.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22172");

(reagent.impl.template.t_reagent$impl$template22172.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template22172");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22172.
 */
reagent.impl.template.__GT_t_reagent$impl$template22172 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template22172(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta22173){
return (new reagent.impl.template.t_reagent$impl$template22172(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta22173));
});

}

return (new reagent.impl.template.t_reagent$impl$template22172(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
