...
var i_12365 = (0);
while(true){
if((i_12365 < arr.length)){
(arr[i_12365] = null);

var G__12366 = (i_12365 + (1));
i_12365 = G__12366;
continue;
} else {
}
...
var i_12373 = (self__.level + (1));
while(true){
if((i_12373 <= (new_level + (1)))){
(update[i_12373] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_12379 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_12379[i]));
} else {
x__$2.forward.push((((i < links_12379.length))?(links_12379[i]):null));
}

if((i < links_12379.length)){
(links_12379[i] = x__$2);
} else {
links_12379.push(x__$2);
}
...
var i_12383 = (0);
while(true){
if((i_12383 <= self__.level)){
var links_12384 = (update[i_12383]).forward;
if((x__$1 === (((i_12383 < links_12384.length))?(links_12384[i_12383]):null))){
(links_12384[i_12383] = (x__$1.forward[i_12383]));

var G__12385 = (i_12383 + (1));
i_12383 = G__12385;
continue;
} else {
var G__12386 = (i_12383 + (1));
i_12383 = G__12386;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__12394 = nx;
var G__12395 = (level__$1 - (1));
x = G__12394;
level__$1 = G__12395;
continue;
} else {
var G__12396 = x;
var G__12397 = (level__$1 - (1));
x = G__12396;
level__$1 = G__12397;
continue;
}
